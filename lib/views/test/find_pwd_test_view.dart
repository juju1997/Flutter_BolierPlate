...
class FindPwdTestView extends StatefulWidget {
  const FindPwdTestView({Key? key}) : super(key: key);

  @override
  _FindPwdTestViewState createState() => _FindPwdTestViewState();
}

class _FindPwdTestViewState extends State<FindPwdTestView> {
  ...
  redirect() async {
    ...
    Navigator.of(context).pushNamed(Routes.sendLinkTest, arguments: args);
  }
}
